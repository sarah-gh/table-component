            ...
            <div class="search-container">
                <div class="form-group select selectSearch">
                    <select v-model="localtablePageSize" @change="changeSelect()" class="pageselect">
                        <option value="" class="disabled-option" disabled selected hidden>تعداد نمایش در هر صفحه</option>
...
.table {
 ...
 .table-form .search-container .selectSearch .pageselect:focus {
 ...
 .table-form .search-container .selectSearch .pageselect {
	 width: 100%;
	 border-radius: 15px;
